...
<div id="left">
	...
	<?php require_once(DOC_ROOT.'app/templates/header.php'); ?>
        <div id="tabs">
            <ul id="tabs-meniu">
                <li><a href="#interni">FURNIZORI</a></li>
            </ul>
            <div id="interni" class="tab">
            <div align="center"> 
            	<a href="#" id="btnIntern" class="ui-state-default ui-state-active" style="padding: .5em 1em; text-decoration: none;" onClick="$(this).addClass('ui-state-active');$('#btnExtern').removeClass('ui-state-active');$('#tip').val('intern');xajax_lista(xajax.getFormValues('frmFiltre'), xajax.getFormValues('frmPager')); return false;">FURNIZORI INTERNI</a> 
                <a href="#" id="btnExtern"  class="ui-state-default" style="padding: .5em 1em; text-decoration: none;" onClick="$(this).addClass('ui-state-active');$('#btnIntern').removeClass('ui-state-active');$('#tip').val('extern_ue');xajax_lista(xajax.getFormValues('frmFiltre'), xajax.getFormValues('frmPager')); return false;">FURNIZORI EXTERNI</a>
            </div>
		...
		?>        
                <br>
               Cu sold
               <input type="checkbox" name="sold" value="DA" onClick="xajax_lista(xajax.getFormValues('frmFiltre'), xajax.getFormValues('frmPager'), 'first');">
                </form>
            </div>
        	</div>
