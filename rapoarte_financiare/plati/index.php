...
<div id="tabs">
<ul id="tabs-meniu">
	<li><a href="#plati" onClick="">Raport Plati</a></li>
	</ul>
<div id="plati" class="tab">
    ...
    <input type="hidden" name="rpt_name" value="RptPlati">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td valign="middle">Modalitati Plata</td>
        <td valign="middle"><?php
		$moduri = new ModalitatiPlata(" where 1 order by ordine asc");
		echo $moduri -> selectMulti();
		?></td>
        <td valign="middle">&nbsp;</td>
      </tr>
      <tr>
