...
<div id="tabs">
<ul id="tabs-meniu">
	<li><a href="#raport" onClick="">Rulaj Terti</a></li>
	</ul>
<div id="raport" class="tab">
    ...
    <input type="hidden" id="rpt_name" name="rpt_name" value="RptRulajClienti">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td colspan="2" valign="middle"><label>
          <input type="radio" name="mod" id="mod" value="clienti" onClick="$('#rpt_name').val('RptRulajClienti')" checked>
          Clienti</label>
          <label>
          <input type="radio" name="mod" id="mod" value="furnizori" onClick="$('#rpt_name').val('RptRulajFurnizori')">
          Furnizori</label>
          </td>
