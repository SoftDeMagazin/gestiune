...
$(document).ready(
	function() {
		...
		if($bon_consum_id) echo 'xajax_load('. $bon_consum_id .');';
      ...
      <td width="70%" valign="top">
        <table width="100%" cellpadding="0"  cellspacing="0">
           ...
           <fieldset>
               ...
               <?php
			   echo iconEdit("xajax_frmComponenta($('#selected_continut_id').val(), $('#bon_consum_id').val())");
...
<div id="div_continut_factura"></div>  
  	<div align="center">
		 <input type="button" name="btnSalveazaFactura" id="btnSalveazaFactura" value="Inchide" onClick="xajax_inchideDocument(xajax.getFormValues('frm_bonuri_consum'));">
    </div>
</div>
</div>    </div>	
</div>    
