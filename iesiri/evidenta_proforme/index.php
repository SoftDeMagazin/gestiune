...
$(document).ready(
	function() {
		...
		$('#gestiune_id').multiSelect({selectAllText: 'Selecteaza tot!', oneOrMoreSelected: '*'}, function() {
			xajax_cautareClient(xajax.getFormValues('frmCautareClient'));
		});			
		$('#txt_numar').keypress(
			function(event) {
				if(event.keyCode == 13) {
...
<div id="left">
    <div id="left-content">
        <div id="tabs">
            <ul id="tabs-meniu">
                <li><a href="#cautare">EVIDENTA PROFORME</a></li>
            </ul>
            <div id="cautare" class="tab">
            <fieldset>
           	<legend>CAUTARE</legend>
                <form action="" method="post" name="frmCautareClient" id="frmCautareClient" onSubmit="return false;">
		...
		?>
                    ...
                    <tr>
                      <td width="20%" scope="col"><strong>Client</strong></td>
                      <td scope="col"><span id="div_frm_client"></span>
					  <input type="button" value="..." onclick="xajax_xWinCautareTert();">
					  </td>
                    </tr>
                    <tr>
                      <td colspan="2"><strong>De la:</strong>                      
                    ...
                    <tr>
                      ...
                      <td>
                          <div align="right">
                            <input type="button" name="btnCauta2" id="btnCauta2" value="Cautare" onClick="xajax_cautareClient(xajax.getFormValues('frmCautareClient'));">
                          </div></td>
                    </tr>
                  </table>
            </form>
