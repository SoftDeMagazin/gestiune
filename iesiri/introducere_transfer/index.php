...
$(document).ready(
	function() {
		...
		if($transfer_id) echo 'xajax_load('. $transfer_id .');';
      ...
      <td width="70%" valign="top">
        <table width="100%" cellpadding="0"  cellspacing="0">
           ...
           <fieldset>
               ...
               <?php
			   echo iconEdit("xajax_frmComponenta($('#selected_continut_id').val(), $('#transfer_id').val())");
			   echo iconRemove("xajax_stergeComponenta($('#selected_continut_id').val())");
			   ?>
			   <input type="button" value="Importa tot stocul" onclick="xajax_importa_stoc($('#transfer_id').val());" />
           </fieldset>    
...
<div id="div_continut_factura"></div>  
  	<div align="center">
		 <input type="button" name="btnSalveazaFactura" id="btnSalveazaFactura" value="Inchide" onClick="xajax_inchideDocument(xajax.getFormValues('frm_transferuri'));">
    </div>
</div>
</div>    </div>	
</div>    
