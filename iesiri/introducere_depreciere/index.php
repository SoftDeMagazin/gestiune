...
$(document).ready(
	function() {
		...
		if($depreciere_id) echo 'xajax_load('. $depreciere_id .');';
      ...
      <td width="70%" valign="top">
        <table width="100%" cellpadding="0"  cellspacing="0">
           ...
           <fieldset>
               ...
               <?php
			   echo iconEdit("xajax_frmComponenta($('#selected_depreciere_continut_id').val(), $('#depreciere_id').val())");
			   echo iconRemove("xajax_stergeComponenta($('#selected_depreciere_continut_id').val())");
			   ?>
           </fieldset>    
