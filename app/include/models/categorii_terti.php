<?php
class CategoriiTerti extends Model
{
	var $tbl="categorii_terti";
	var $_relations = array(
		);
	var $_defaultForm = array(
		"categorie_tert_id" => array("type" => "hidden"),
		"denumire" => array("type"=>"text", "label"=>"Denumire Categorie", "attributes" => array( "style" => "width:400px;")),
		);
