<?php
class TransferuriContinut extends Model
{
	var $tbl="transferuri_continut";
	...
	var $_defaultForm = array(
		...
		"pret_fara_tva" => array("type"=>"text", "label"=>"Pret Fara TVA", "attributes" => array()),
		);
	...
	function frmContinut() {
		...
		<div align="right">
<input type="button" name="btnSalveaza" id="btnSalveazaComp" value="Salveaza" onClick="xajax_saveComponenta(xajax.getFormValues(\'frm_transferuri_continut\'), $(\'#transfer_id\').val())">
		<input type="button" name="btnAnuleaza" id="btnAnuleaza" value="Anuleaza" onClick="xajax_frmComponenta(0, $(\'#transfer_id\').val())">		</div>
		';
