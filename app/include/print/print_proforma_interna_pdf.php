 ...
 */
class PrintProformaInternaPdf extends PrintProforma {
	var $inaltime_pozitie = 6;
	var $inaltime_nc8 = 5;
	var $inaltime_pagina = 140;
	function __construct($proforma_id) {
		parent::__construct($proforma_id);
	}
	...
	function continutFactura() {
		...
		$continut = new FacturiProformeContinut();
