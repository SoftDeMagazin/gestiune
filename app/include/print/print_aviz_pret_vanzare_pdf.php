 ...
 */
class PrintAvizPretVanzarePdf extends PdfHelper {
	...
	function __construct($aviz_id) {
		...
		switch($this -> aviz -> tip_aviz) {
			case "doc_pv": {
				$this -> societate = $this -> aviz -> gestiune -> societate;
				$this -> tert = new Terti($this -> aviz -> tert_id);
			}break;
		}
		$this -> pdfProperties();
	}
	...
	function infoSocietate() {
		...
		$this -> text("GESTIUNE: ". $this -> aviz -> gestiune -> denumire, $left,41, 10);
	}
	/**
	 * informatii client
	 * @return 
