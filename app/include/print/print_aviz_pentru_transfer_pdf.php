 ...
 */
class PrintAvizPentruTransferPdf extends PdfHelper {
	...
	function total() {
		...
		$total_aviz = number_format($this -> aviz -> totalAviz(), 2, ',', '.');
	...
	function continutFactura() {
		...
		$sql = "
				...
				loturi.pret_intrare_ron as pret_vanzare_ron,
				...
				inner join produse on avize_iesiri.produs_id = produse.produs_id
				where avize_continut.aviz_id = '". $this -> aviz -> id ."'
				group by avize_iesiri.produs_id, produse.denumire, loturi.pret_intrare_ron
				";
