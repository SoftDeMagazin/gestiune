<?php
	...
	function &onAddColumn($mData, $mConfiguration)
	{
		...
		$objCell = new clsTableCell(array(
			'attributes' => array(
				'id' => $column
				),
	...
	function &onAddRow($mData, $mConfiguration)
	{
		...
		if (1 == count($mConfiguration)) {
			...
			$objTableRow->addChild(new clsTableCell(array(
				'child' => new clsAnchor(array(
	...
	function &onAddFooterRow($mData, $mConfiguration)
	{
		...
		$objRow = new clsTableRow(array(
			'child' => new clsTableCell(array(
				'attributes' => array(
					'colspan' => 4
					),
	...
	$table = new clsTable(array(
		'children' => array(
			new clsTableHeader(array(
				'children' => array(
					new clsTableRow(array(
						'children' => array(
							new clsTableCell(array(
								'children' => array(
