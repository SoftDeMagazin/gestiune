...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#meniu').accordion('activate', <?=DASHBOARD?>);
        $('#tabs').tabs();
                                ...
                                <form id="frm_produse_gestiuni" name="frm_produse_gestiuni" method="post">
                                    <fieldset>
                                        ...
                                        <p>
                                            ...
                                            <input type="text" id="produs" name="produs" size=25>
                                        </p>
                                        <p>
                                            <div>
                                                <label for="gestiune">
                                        ...
                                        <p>
                                            <div align="right">
                                                <a href="#" id="btnSave" class="ui-state-default" style="padding: .5em 1em; text-decoration: none;" onClick="if(validate()){xajax_save(xajax.getFormValues('frm_produse_gestiuni'));};">Salveaza</a>
                                            </div>
                                        </p>
                                        <br>
                                    </fieldset>
