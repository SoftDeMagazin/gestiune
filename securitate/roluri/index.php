...
<ul id="tabs-meniu">
	...
	<li><a href="#drepturi">Drepturi</a></li>
</ul>
<div id="lista" class="tab">
<div id="filtre" class="filtre" style="width: 50%; float: left">
<form id="frmFiltre" onSubmit="return false;">Rol: <input name="rol"
	type="text" size="25"
...
<?php
	echo toolbar('rol_id', $_SESSION['user']->permissions['22']);
?>
...
<div id="drepturi" class="tab">
<table width="100%" border="0" cellspacing="4" cellpadding="2">
    <tr>
        <td width="250px">
        	<div id="div_load_module" align="center">
        		<?php
				$module = new Module("where modul_activ = 1 order by category_index, item_index");
				echo $module -> selectSize("xajax_loadDrepturi($('#frm #rol_id').val(), $(this).val());");
				?>
        	</div>
        </td>
        <td valign="top">
        	<div id="div_modul" style="font-size:12px; font-weight:bold;"></div>
        	<div id="div_load_drepturi"></div>
        </td>
    </tr>
</table>
